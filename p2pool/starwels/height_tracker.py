...
class HeaderWrapper(object):
    ...
    def from_header(cls, header):
        return cls(starwels_data.hash256(starwels_data.block_header_type.pack(header)), header['previous_block'])
...
@defer.inlineCallbacks
def get_height_rel_highest_func(starwelsd, factory, best_block_func, net):
    if '\ngetblock ' in (yield deferral.retry()(starwelsd.rpc_help)()):
