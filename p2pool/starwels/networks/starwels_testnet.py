...
BLOCK_EXPLORER_URL_PREFIX = 'http://localhost/testnet/block/'
ADDRESS_EXPLORER_URL_PREFIX = 'http://localhost/testnet/address/'
TX_EXPLORER_URL_PREFIX = 'http://localhost/testnet/tx/'
